var quotes = [
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q1.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    <p class="lead fw-normal pt-2 my-0">“Be yourself; everyone else is already taken.”</p>
    <p class="fw-bold fs-3 my-0">- Oscar Wilde -</p>`
    ,

    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q2.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    ...
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q3.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    <p class="lead fw-normal pt-2 my-0">“So many books, so little time.”</p>
    <p class="fw-bold fs-3 my-0">- Frank Zappa -</p>`
    ,

    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q4.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    ...
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q5.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    ...
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q6.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    ...
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q7.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
    ...
    `<div class="w-small mt-xxl-5 mt-xl-4 mt-2"> <img src="image/Q8.jpg" class="w-100 h-100 rounded-circle" alt="person"> </div>
